...
test('spot', function (t) {
  [ [ { line: 0, column: 2 }, 2, '2' ] 
  , [ { line: 1, column: 2 }, 10, '2' ] 
  , [ { line: 2, column: 4 }, 22, '4' ] 
  ]
  .forEach(function (x) {
     var loc = x[0], spot = x[1], c = x[2];
     var sp = locator.spot(loc);
     t.equal(sp, spot, inspect(x))
     t.equal(text[sp], c)
  })
  t.end()
})
...
test('location', function (t) {
  ...
  .forEach(function (x) {
     var loc = x[0], spot = x[1], c = x[2];
     var location = locator.location(spot);
...
test('range', function (t) {
  ...
  .forEach(function (x) {
     ...
     var range = locator.range(loc1, loc2);
...
test('roundtrip range -> locations', function (t) {
  ...
  .forEach(function (x) {
     ...
     var locs = locator.locations([r1, r2 ])
     var range = locator.range(locs.start, locs.end); 
...
test('roundtrip spot -> location', function (t) {
  [ [ { line: 0, column: 2 }, 2  ] 
  , [ { line: 1, column: 2 }, 10 ] 
  , [ { line: 2, column: 4 }, 22 ] 
  ]
